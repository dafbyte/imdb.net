...
namespace ImdbNet.Core
{
    public class Utils
    {
		...
		{
			return await GetSuggestionsResultsAsync<TitlesSuggestionsResults>(Urls.SuggestionsTitles, query);
		}
		...
		public static async Task<NamesSuggestionsResults> GetNamesSuggestionsAsync(string query) =>
			await GetSuggestionsResultsAsync<NamesSuggestionsResults>(Urls.SuggestionsNames, query);
        ...
        {
            public const string SuggestionsTitles = "https://v2.sg.media-imdb.com/suggests/titles";
            public const string SuggestionsNames = "https://v2.sg.media-imdb.com/suggests/names";
        }
	}
}
